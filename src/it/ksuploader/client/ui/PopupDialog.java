...
public class PopupDialog extends Observable {
	...
	private JLabel headingLabel, messageLabel;
	...
	private void autoPosition() {
		...
		dialogFrame.setLocation(scrSize.width - 10 - dialogFrame.getWidth(), scrSize.height - 5 - toolHeight.bottom - dialogFrame.getHeight());
	}
