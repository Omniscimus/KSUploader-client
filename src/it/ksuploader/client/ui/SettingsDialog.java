...
public class SettingsDialog extends JDialog implements NativeKeyListener {
	private final JTextField ftpAddr, ftpPort, ftpDir, ftpWeburl, ftpUser, ftpPassw, srvAddr, srvPassw, srvPort;
	private final JCheckBox ftpEnabled, saveEnabled, startUpEnabled, ftpesEnabled, acceptCertificates;
	private JFileChooser saveDir;
	private final JButton btnScreen, btnCScreen, btnFile, btnClipboard;
	 ...
	 * LISTENER
	 */
	private JButton callerBtn;

	private String newKey;
	private HashSet<Integer> hashKeyGlobal = new HashSet<>();
	private boolean hash1Ready = false;
	private boolean hash2Ready = false;

	private void enableListener(JButton btn) {
